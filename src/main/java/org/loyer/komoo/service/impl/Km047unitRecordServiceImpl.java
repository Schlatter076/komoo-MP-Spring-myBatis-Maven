...
import org.loyer.komoo.dao.Ikm047unitRecordDao;
import org.loyer.komoo.service.IRecordDataService;

public class Km047unitRecordServiceImpl implements IRecordDataService {

  private Ikm047unitRecordDao dao;
  
  public void setDao(Ikm047unitRecordDao dao) {
    this.dao = dao;
  }
