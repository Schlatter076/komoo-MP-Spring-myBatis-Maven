...
import org.loyer.komoo.dao.Ikm033unitTestDao;
import org.loyer.komoo.service.ITestDataService;

public class Km033unitTestServiceImpl implements ITestDataService {

  private Ikm033unitTestDao dao;
  
  public void setDao(Ikm033unitTestDao dao) {
    this.dao = dao;
  }
