...
import org.loyer.komoo.commands.KM130Commands;
...
public class KM130Client extends LoyerFrame {
  ...
  /** 本类日志记录对象 */
  private static final Logger logger = LoggerFactory.getLogger(KM130Client.class);
  ...
  public static void getDataView(ApplicationContext ac, String type, String base, String baseType) {
    EventQueue.invokeLater(new Runnable() {
      ...
      @Override
      public void run() {
        KM130Client win = new KM130Client(ac, type, base, baseType);
  ...
  public KM130Client(ApplicationContext ac, String type, String base, String baseType) {
  ...
  public void TOKYtest() {
    ...
    // step4
    if (!com2SendMultiple(KM130Commands.SET_WA)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    // step5
    if (!com2SendMultiple(KM130Commands.SET_SEAT)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    if (!autoSetMultipleRowResultStatu(11, (com1Bytes[3] & (1 << 1)) != 0 ? 1 : 0) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
    for (int i = 12; i < 18; i++) {
    ...
    if (!setADC(String.format("%02X", com1Bytes[2]), 18) && !spotButt.isSelected()) {
      setResultNG();
      return;
    }
    com1HasData = false;
    // com1Buzy.signal();
    // step12
    if (!com2SendMultiple(KM130Commands.SET_WSTEP_1)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    if (!setADC(String.format("%02X", com1Bytes[2]), 19) && !spotButt.isSelected()) {
      setResultNG();
      return;
    }
    com1HasData = false;
    // com1Buzy.signal();
    // step13
    if (!com2SendMultiple(KM130Commands.SET_WSTEP_3)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    // com1Buzy.signal();
    // step14
    if (!com2SendMultiple(KM130Commands.SET_WSTEP_2)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    // com1Buzy.signal();
    // step15
    if (!com2SendMultiple(KM130Commands.SET_WSTEP_4)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    if (!setADC(String.format("%02X", (com1Bytes[2] >> 2) & 0x1f), 23) && !spotButt.isSelected()) {
      setResultNG();
      return;
    }
    com1HasData = false;
    // com1Buzy.signal();
    // step17
    if (!com2SendMultiple(KM130Commands.SET_WNOZZLE_1)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    if (!setADC(String.format("%02X", (com1Bytes[2] >> 2) & 0x1f), 24) && !spotButt.isSelected()) {
      setResultNG();
      return;
    }
    com1HasData = false;
    // com1Buzy.signal();
    // step18
    if (!com2SendMultiple(KM130Commands.SET_WNOZZLE_3)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    // com1Buzy.signal();
    // step19
    if (!com2SendMultiple(KM130Commands.SET_WNOZZLE_2)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    // com1Buzy.signal();
    // step20
    if (!com2SendMultiple(KM130Commands.SET_WNOZZLE_4)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    if (!autoSetMultipleRowResultStatu(28, (com1Bytes[2] & (1 << 4)) != 0 ? 1 : 0) && !spotButt.isSelected()) {
      setResultNG();
      return;
    }
    com1HasData = false;
    // com1Buzy.signal();
    // step22
    if (!com2SendMultiple(KM130Commands.SET_WPUMP)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    if (!autoSetMultipleRowResultStatu(29, (com1Bytes[2] & (1 << 4)) != 0 ? 1 : 0) && !spotButt.isSelected()) {
      setResultNG();
      return;
    }
    com1HasData = false;
    ...
    if (!autoSetMultipleRowResultStatu(30, (com1Bytes[2] & (1 << 6)) != 0 ? 1 : 0) && !spotButt.isSelected()) {
      setResultNG();
      return;
    }
    com1HasData = false;
    // com1Buzy.signal();
    // step26
    if (!com2SendMultiple(KM130Commands.SET_WVALUE)) {
      setResultNG();
      return;
    }
    com2HasData = false;
    ...
    if (!autoSetMultipleRowResultStatu(31, (com1Bytes[2] & (1 << 6)) != 0 ? 1 : 0) && !spotButt.isSelected()) {
      setResultNG();
      return;
    }
    com1HasData = false;
    // com1Buzy.signal();
    // step27
    if (!com2SendMultiple(KM130Commands.CLR_ALL)) {
      setResultNG();
      return;
    }
    ...
    if (!autoSetMultipleRowResultStatu(33, (com2Bytes[5] & (1 << 4)) != 0 ? 1 : 0) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[6] << 8) | (com2Bytes[7] & 0xff)), 34) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[8] << 8) | (com2Bytes[9] & 0xff)), 35) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[10] << 8) | (com2Bytes[11] & 0xff)), 36) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[14] << 8) | (com2Bytes[15] & 0xff)), 37) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
    if (isSetMultipleRowNG) {
      isSetMultipleRowNG = false;
    ...
    if (!autoSetMultipleRowResultStatu(38, (com2Bytes[5] & (1 << 1)) != 0 ? 1 : 0) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
    if (!autoSetMultipleRowResultStatu(39, (com2Bytes[5] & (1 << 4)) != 0 ? 1 : 0) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[6] << 8) | (com2Bytes[7] & 0xff)), 40) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[8] << 8) | (com2Bytes[9] & 0xff)), 41) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[10] << 8) | (com2Bytes[11] & 0xff)), 42) && !spotButt.isSelected()) {
      isSetMultipleRowNG = true;
    }
