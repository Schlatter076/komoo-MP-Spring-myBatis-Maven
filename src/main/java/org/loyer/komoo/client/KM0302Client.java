...
public class KM0302Client extends LoyerFrame {
  ...
  public void TOKYtest() {
    ...
    for (int i = 25; i < 29; i++) {
      if (!autoSetMultipleRowResultStatu(i, (com1Bytes[2] & (1 << (3 + (i - 25)))) != 0 ? 1 : 0)) {
        isSetMultipleRowNG = true;
      }
    }
    ...
    for (int i = 29; i < 33; i++) {
      if (!autoSetMultipleRowResultStatu(i, (com1Bytes[2] & (1 << (3 + (i - 29)))) != 0 ? 1 : 0)) {
        isSetMultipleRowNG = true;
      }
    }
    ...
    for (int i = 33; i < 37; i++) {
      if (!autoSetMultipleRowResultStatu(i, (com1Bytes[2] & (1 << (3 + (i - 33)))) != 0 ? 1 : 0)) {
        isSetMultipleRowNG = true;
      }
    }
    ...
    for (int i = 37; i < 41; i++) {
      if (!autoSetMultipleRowResultStatu(i, (com1Bytes[2] & (1 << (3 + (i - 37)))) != 0 ? 1 : 0)) {
        isSetMultipleRowNG = true;
      }
    }
    ...
    if (!autoSetMultipleRowResultStatu(41, (com1Bytes[2] & (1 << 7)) != 0 ? 1 : 0)) {
      isSetMultipleRowNG = true;
    }
    for (int i = 42; i < 45; i++) {
      if (!autoSetMultipleRowResultStatu(i, (com1Bytes[3] & (1 << (i - 42))) != 0 ? 1 : 0)) {
        isSetMultipleRowNG = true;
      }
    }
    ...
    if (!autoSetMultipleRowResultStatu(45, (com1Bytes[2] & (1 << 7)) != 0 ? 1 : 0)) {
      isSetMultipleRowNG = true;
    }
    for (int i = 46; i < 49; i++) {
      if (!autoSetMultipleRowResultStatu(i, (com1Bytes[3] & (1 << (i - 46))) != 0 ? 1 : 0)) {
        isSetMultipleRowNG = true;
      }
    }
    ...
    if (!autoSetMultipleRowResultStatu(49, (com1Bytes[2] & (1 << 7)) != 0 ? 1 : 0)) {
      isSetMultipleRowNG = true;
    }
    for (int i = 50; i < 53; i++) {
      if (!autoSetMultipleRowResultStatu(i, (com1Bytes[3] & (1 << (i - 50))) != 0 ? 1 : 0)) {
        isSetMultipleRowNG = true;
      }
    }
    ...
    if (!autoSetMultipleRowResultStatu(53, (com1Bytes[2] & (1 << 7)) != 0 ? 1 : 0)) {
      isSetMultipleRowNG = true;
    }
    for (int i = 54; i < 57; i++) {
      if (!autoSetMultipleRowResultStatu(i, (com1Bytes[3] & (1 << (i - 54))) != 0 ? 1 : 0)) {
        isSetMultipleRowNG = true;
      }
    }
    ...
    if (!autoSetMultipleRowResultStatu(57, (com1Bytes[2] & (1 << 6)) != 0 ? 1 : 0)) {
      setResultNG();
      return;
    }
    ...
    if (!autoSetMultipleRowResultStatu(58, (com1Bytes[2] & (1 << 7)) != 0 ? 1 : 0)) {
      setResultNG();
      return;
    }
    ...
    if (!autoSetMultipleRowResultStatu(59, (com1Bytes[2] & (1 << 3)) != 0 ? 1 : 0)) {
      setResultNG();
      return;
    }
    ...
    if (!autoSetMultipleRowResultStatu(60, (com1Bytes[2] & (1 << 3)) != 0 ? 1 : 0)) {
      setResultNG();
      return;
    }
    ...
    if (!autoSetMultipleRowResultStatu(63, (com2Bytes[5] & (1 << 4)) != 0 ? 1 : 0)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[6] << 8) | (com2Bytes[7] & 0xff)), 64)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[8] << 8) | (com2Bytes[9] & 0xff)), 65)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[10] << 8) | (com2Bytes[11] & 0xff)), 66)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[12] << 8) | (com2Bytes[13] & 0xff)), 67)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[14] << 8) | (com2Bytes[15] & 0xff)), 68)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[18] << 8) | (com2Bytes[19] & 0xff)), 69)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[20] << 8) | (com2Bytes[21] & 0xff)), 70)) {
      isSetMultipleRowNG = true;
    }
    if (isSetMultipleRowNG) {
      isSetMultipleRowNG = false;
    ...
    if (!autoSetMultipleRowResultStatu(73, (com2Bytes[5] & (1 << 4)) != 0 ? 1 : 0)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[6] << 8) | (com2Bytes[7] & 0xff)), 74)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[8] << 8) | (com2Bytes[9] & 0xff)), 75)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[10] << 8) | (com2Bytes[11] & 0xff)), 76)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[12] << 8) | (com2Bytes[13] & 0xff)), 77)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[14] << 8) | (com2Bytes[15] & 0xff)), 78)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[18] << 8) | (com2Bytes[19] & 0xff)), 79)) {
      isSetMultipleRowNG = true;
    }
    if (!setADC(String.format("%03X", (com2Bytes[20] << 8) | (com2Bytes[21] & 0xff)), 80)) {
      isSetMultipleRowNG = true;
    }
    if (isSetMultipleRowNG) {
      isSetMultipleRowNG = false;
